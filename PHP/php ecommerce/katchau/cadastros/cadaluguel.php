...
$sqlClientes = $conn -> query("SELECT*FROM clientes");
$clientes = $sqlClientes->fetchAll(PDO::FETCH_OBJ);

$sqlCarros = $conn -> query("SELECT*FROM carros WHERE disponibilidade=1");
$carros = $sqlCarros->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron" style="color: #FD2F4C !important">
                    ...
                    <form action="functions/func_cadaluguel.php" method="POST">
                        ...
                        <div class="form-group" id="data"><label for="data">Data da retirada</label>
                            <input type="date" class="form-control" name="data" id="data" min="<?php date_default_timezone_set("America/Sao_Paulo"); echo date('Y-m-d',time());?>">
                        </div>
